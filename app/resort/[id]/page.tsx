...
export default function ResortPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Agresivno čišćenje ID-a
  const cleanId = resolvedParams.id.replace(/\D/g, "");
    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#020617]">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        {!resort ? (
          ...
          <div className="bg-white dark:bg-white/5 p-12 rounded-[4rem] border border-black/5 shadow-2xl relative overflow-hidden">

  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#020617] text-slate-900 dark:text-slate-100 transition-colors duration-500 font-sans">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="rounded-[2.5rem] overflow-hidden border dark:border-white/10 mb-8 shadow-2xl h-[480px] bg-slate-50 dark:bg-slate-900/50">
          <BalkanMap resorts={resorts} timeframe={timeframe} />
        </div>

        {/* TIME SPAN SELEKTOR - VRAĆEN NA SREDU */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {loading ? (
            <div className="col-span-full text-center py-20 font-black uppercase opacity-20 animate-pulse tracking-widest italic">Skeniranje Balkana...</div>
          ) : (
            resorts.map((resort) => {
              let calcSnow = 0;
              ...
              return (
                <div key={resort.id} className="bg-slate-50 dark:bg-white/5 border dark:border-white/10 p-7 rounded-[3.5rem] flex flex-col h-full hover:shadow-xl transition-all group">
                  ...
                  <div className="h-44 bg-blue-600 p-8 rounded-[2.5rem] text-white relative overflow-hidden shadow-xl shadow-blue-600/30 mb-8 flex flex-col justify-center">
                    ...
                    <p className="text-6xl font-black italic tracking-tighter">+{calcSnow.toFixed(1)} <span className="text-2xl font-normal opacity-40 uppercase ml-1 tracking-normal">cm</span></p>
                  </div>
